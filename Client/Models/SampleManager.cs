...
): IStartable
{
    public async void Start()
    {
        ...
        var db_status_service = MagicOnionClient.Create<MY_DB.IStatusService>(db_channel);
        ...
        var user_db_service =  MagicOnionClient.Create<MY_DB.IAuthService>(db_channel);
        ...
        {
            var user = new User(x.username, x.password);
